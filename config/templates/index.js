...
mod.run(($templateCache) => {
    // customPosts
    $templateCache.put('home/list.html', require('!html!./home/list.html'));
    $templateCache.put('home/menu.html', require('!html!./home/menu.html'));
    $templateCache.put('module/search.html', require('!html!./modules/search.html'));

    $templateCache.put('directive/posts.html', require('!html!./modules/posts.html'));
    $templateCache.put('directive/post.html', require('!html!./modules/post.html'));
    $templateCache.put('directive/postToolbar.html', require('!html!./modules/postToolbar.html'));

    $templateCache.put('directive/author.html', require('!html!./modules/author.html'));
    $templateCache.put('directive/emptyList.html', require('!html!./directives/emptyList.html'));

    $templateCache.put('module/bookmark.html', require('!html!./modules/bookmark.html'));
